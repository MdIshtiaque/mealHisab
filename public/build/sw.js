...
class fe {
  ...
  async cachePut(e, t) {
    ...
    if (!r)
      return !1;
    const { cacheName: i, matchOptions: c } = this._strategy, o = await self.caches.open(i), h = this.hasCallback("cacheDidUpdate"), m = h ? await he(
...
let y;
const we = () => (y || (y = new me(), y.addFetchListener(), y.addCacheListener()), y);
function g(s, e, t) {
  let n;
  if (typeof s == "string") {
...
const Y = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap(), X = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakMap(), S = /* @__PURE__ */ new WeakMap();
function Te(s) {
...
function Ne(s) {
  return s === IDBDatabase.prototype.transaction && !("objectStoreNames" in IDBTransaction.prototype) ? function(e, ...t) {
    ...
    return s.apply(L(this), e), f(Y.get(this));
  } : function(...e) {
    return f(s.apply(L(this), e));
  };
}
function Me(s) {
  return typeof s == "function" ? Ne(s) : (s instanceof IDBTransaction && ke(s), De(s, Ue()) ? new Proxy(s, I) : s);
}
function f(s) {
...
const Ke = ["get", "getKey", "getAll", "getAllKeys", "count"], Se = ["put", "add", "delete", "clear"], N = /* @__PURE__ */ new Map();
function F(s, e) {
...
const Oe = "workbox-expiration", R = "cache-entries", H = (s) => {
...
class ve {
   ...
   */
  async getDb() {
    return this._db || (this._db = await Ie(Oe, 1, {
...
xe([{"revision":null,"url":"assets/app-4db4c63a.js"},{"revision":null,"url":"assets/app-aa06debb.css"},{"revision":null,"url":"assets/sw-408df573.js"},{"revision":"2d094791c49e920331981a2d203b8cdb","url":"registerSW.js"},{"revision":"a0b217030305a4f3b1134454dc50e28c","url":"manifest.webmanifest"}]);
g(
...
g(
  ({ request: s }) => s.destination === "image" || s.url.includes("/icons/"),
  new A({
...
self.addEventListener("install", (s) => {
  ...
  s.waitUntil(
    caches.open("offline").then((t) => t.put("/offline", e))
  );
});
g(
  ({ request: s }) => s.mode === "navigate",
